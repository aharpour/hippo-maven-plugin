...
public class DefaultMethodGeneratorTest {
	...
	public void hippoHtmlMethodTest() {
		...
		DefaultMethodGenerator htmlMethodGenerator = new DefaultMethodGenerator(
				new ContentTypeItemAnalyzer(null, null).new AnalyzerResult(Type.HIPPO_HTML, returnType),
				Utils.mockItem("mavenhippoplugindemo:summary", false), new ImportRegistry());
	...
	public void linkedItemMethodTest() {
		...
		DefaultMethodGenerator htmlMethodGenerator = new DefaultMethodGenerator(
				new ContentTypeItemAnalyzer(null, null).new AnalyzerResult(Type.LINKED_BEAN, returnType),
				Utils.mockItem("mavenhippoplugindemo:conference", false), new ImportRegistry());
		String fragment = htmlMethodGenerator.getFragment();
	...
	public void linkedMultiItemMethodTest() {
		...
		DefaultMethodGenerator htmlMethodGenerator = new DefaultMethodGenerator(
				new ContentTypeItemAnalyzer(null, null).new AnalyzerResult(Type.LINKED_BEAN, returnType),
				Utils.mockItem("mavenhippoplugindemo:conference", true), new ImportRegistry());
		String fragment = htmlMethodGenerator.getFragment();
		Assert.assertEquals(
	...
	public void propertyMethodTest() {
		...
		DefaultMethodGenerator htmlMethodGenerator = new DefaultMethodGenerator(
				new ContentTypeItemAnalyzer(null, null).new AnalyzerResult(Type.PROPERTY, returnType), Utils.mockItem(
						"mavenhippoplugindemo:name", false), new ImportRegistry());
		String fragment = htmlMethodGenerator.getFragment();
		Assert.assertEquals(
	...
	public void propertyMultivalueMethodTest() {
		...
		DefaultMethodGenerator htmlMethodGenerator = new DefaultMethodGenerator(
				new ContentTypeItemAnalyzer(null, null).new AnalyzerResult(Type.PROPERTY, returnType), Utils.mockItem(
						"mavenhippoplugindemo:address", true), new ImportRegistry());
		String fragment = htmlMethodGenerator.getFragment();
		Assert.assertEquals(
	...
	public void nodeMethodTest() {
		...
		DefaultMethodGenerator htmlMethodGenerator = new DefaultMethodGenerator(
				new ContentTypeItemAnalyzer(null, null).new AnalyzerResult(Type.NODE, returnType), Utils.mockItem(
						"mavenhippoplugindemo:item", false), new ImportRegistry());
		String fragment = htmlMethodGenerator.getFragment();
		Assert.assertEquals(
	...
	public void nodeMultiItemMethodTest() {
		...
		DefaultMethodGenerator htmlMethodGenerator = new DefaultMethodGenerator(
				new ContentTypeItemAnalyzer(null, null).new AnalyzerResult(Type.NODE, returnType), Utils.mockItem(
						"mavenhippoplugindemo:items", true), new ImportRegistry());
		String fragment = htmlMethodGenerator.getFragment();
		Assert.assertEquals(
