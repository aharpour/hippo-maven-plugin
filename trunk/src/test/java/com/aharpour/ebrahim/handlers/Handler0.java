...
@Weight(0.1)
public class Handler0 extends ContentTypeItemHandler {

	public Handler0(Map<String, HippoBeanClass> beansOnClassPath, Map<String, HippoBeanClass> beansInProject) {
