...
@Weight(value = 8.0)
public class SuperClassHandler2 extends DefaultSupperClassHandler {

    public SuperClassHandler2(Map<String, HippoBeanClass> beansOnClassPath, Map<String, HippoBeanClass> beansInProject, ClassLoader classLoader, Set<String> namespaces, Map<String, ContentTypeBean> mixins) {
