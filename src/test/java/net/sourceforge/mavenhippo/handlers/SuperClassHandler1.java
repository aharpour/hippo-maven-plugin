...
@Weight(value = 10.0)
public class SuperClassHandler1 extends DefaultSupperClassHandler{

    public SuperClassHandler1(Map<String, HippoBeanClass> beansOnClassPath, Map<String, HippoBeanClass> beansInProject, ClassLoader classLoader, Set<String> namespaces, Map<String, ContentTypeBean> mixins) {
