...
@Weight(value = -14.0)
public class SuperClassHandler4 extends DefaultSupperClassHandler{

    public SuperClassHandler4(Map<String, HippoBeanClass> beansOnClassPath, Map<String, HippoBeanClass> beansInProject, ClassLoader classLoader, Set<String> namespaces, Map<String, ContentTypeBean> mixins) {
